...
public interface PaqueteDeViajeDao {
	 ...
	 * @return instancia del paquete de viaje con los datos que se guardaron.
	 * @throws IWDaoException
	 */
	public PaqueteDeViaje guardar(PaqueteDeViaje paquetedeviaje) throws IWDaoException;
	 ...
	 * @return instancia del paquete de viaje con los datos que se actualizaron.
	 * @throws IWDaoException
	 */
	public PaqueteDeViaje actualizar(PaqueteDeViaje paquetedeviaje) throws IWDaoException;
